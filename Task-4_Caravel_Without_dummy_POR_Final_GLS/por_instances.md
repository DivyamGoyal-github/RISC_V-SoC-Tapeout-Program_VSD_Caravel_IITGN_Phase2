...
[dgoyal@nanodc rtl]$ grep "por*" vsdcaravel.v 
...
//    .vdda (vdda_core),   // Management 3.3V power
      ...
      .por_l(por_l),
      .mprj_io_analog_pol(mprj_io_analog_pol),
[dgoyal@nanodc rtl]$ grep "dummy*" vsdcaravel.v 
[dgoyal@nanodc rtl]$ grep "por*" chip_io.v 
// SPDX-FileCopyrightText: 2025 Efabless Corporation/VSD
	input  porb_h,
	input  por,
...
[dgoyal@nanodc rtl]$ grep "por*" caravel_core.v 
// SPDX-FileCopyrightText: 2025 Efabless Corporation/VSD
...
[dgoyal@nanodc rtl]$ grep "dummy*" caravel_core.v 
    dummy_por por (
[dgoyal@nanodc rtl]$ grep "dummy*" chip_io.v 
    wire [`MPRJ_IO_PADS-1:0] dummy_mprj_io_in;
	//wire dummy;
        //nand signal_gating (dummy, gpio_inenb_core, gpio_out_core)
[dgoyal@nanodc rtl]$ grep "dummy*" caravel_clocking.v 
[dgoyal@nanodc rtl]$ grep "por*" caravel_clocking.v 
// SPDX-FileCopyrightText: 2025 Efabless Corporation/VSD
...
[dgoyal@nanodc rtl]$ grep "dummy*" housekeeping.v 
[dgoyal@nanodc rtl]$ grep "por*" housekeeping.v 
// SPDX-FileCopyrightText: 2025 Efabless Corporation/VSD
...
[dgoyal@nanodc rtl]$ grep "dummy*" caravel_netlists.v 
    //`include "dummy_por.v"
    `include "dummy_por.v"
[dgoyal@nanodc rtl]$ grep "por*" caravel_netlists.v 
// SPDX-FileCopyrightText: 2025 Efabless Corporation/VSD
    //`include "dummy_por.v"
    `include "dummy_por.v"
[dgoyal@nanodc rtl]$ 
...
[dgoyal@nanodc vsdRiscvScl180]$ grep -r -i -n "por\|dummy_por" --include="*.v" --include="*.sv" .
...
[dgoyal@nanodc vsdRiscvScl180]$ 

# Perform Audit

cd /home/dgoyal/vsdRiscvScl180/rtl
grep -r -i -n -E "(dummy_por|porb_h|porb_l|por_l|\.porb|\.por\>|input[[:space:]]+por|output[[:space:]]+por)" --include="*.v" --include="*.sv" . > /home/dgoyal/complete_por_audit.txt

[dgoyal@nanodc rtl]$ grep -r -i -n "rstb\|reset_n\|xres" --include="*.v" --include="*.sv" . | grep -i "input\|inout"
...
[dgoyal@nanodc rtl]$ grep -r -i -E "(dummy_por|\.porb|\.por\>|input[[:space:]]+por|output[[:space:]]+por)" --include="*.v" --include="*.sv" .
